//
//  SJCicadaMediaPlayerLayerView.m
//  Pods
//
...
@implementation SJCicadaMediaPlayerLayerView
...
- (void)setVideoGravity:(SJVideoGravity)videoGravity {
    ...
    if ( self.videoGravity == AVLayerVideoGravityResize ) {
        _player.scalingMode = CICADA_SCALINGMODE_SCALETOFILL;
    }
    else if ( self.videoGravity == AVLayerVideoGravityResizeAspect ) {
        _player.scalingMode = CICADA_SCALINGMODE_SCALEASPECTFIT;
    }
    else if ( self.videoGravity == AVLayerVideoGravityResizeAspectFill ) {
        _player.scalingMode = CICADA_SCALINGMODE_SCALEASPECTFILL;
    }
}
